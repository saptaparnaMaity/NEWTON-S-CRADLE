...
function setup() {
	...
	bobObject1 = new Ball (340,470,20)
	bobObject2 = new Ball (380,470,20)
	bobObject3 = new Ball (420,470,20)
	bobObject4 = new Ball (460,470,20)
	bobObject5 = new Ball (500,470,20);
